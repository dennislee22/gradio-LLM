...
DEFAULT_CKPT_PATH = "Qwen2.5-7B-Instruct"
...
def _launch_demo(args, model, tokenizer):
    ...
    with gr.Blocks() as demo:
        gr.Markdown("""\
<p align="center"><img src="https://vectorseek.com/wp-content/uploads/2022/04/Bank-AlJazira-Logo-Vector.svg-.png" style="height: 120px"/><p>""")
        gr.Markdown(
            """\
<center><font size=3>Chabot powered by CML/CAI \
</center>"""
        )
        gr.Markdown("""\
<center><font size=4>
Bank Aljazira <a href="https://www.bankaljazira.com/en-us/"> </a> | 
&nbsp<a href="https://www.bankaljazira.com/en-us/">BAJ</a></center>""")
